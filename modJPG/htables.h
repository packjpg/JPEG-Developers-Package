...
// sign relevancy scan
unsigned char sgnscan[] =
{
	 0,  1,  2,  3,  5,  6,  9, 10,
	14, 15, 20, 21, 27, 28, 35,  7,
	 8, 11, 13, 16, 19, 22, 26, 29,
	34,	36, 42, 17, 18, 23, 25, 30,
	33,	37, 41, 43, 48, 31, 32, 38,
	40,	44, 47, 49, 53, 45, 46, 50,
	52,	54, 57, 55, 56, 58, 60, 61,
	62,  4, 12, 24, 39, 51, 59, 63
};
...
// configuration sets for category number maxima
const unsigned char conf_cnum[][3] =
{
	{ 11,  9,  9 },
	{ 10,  8,  8 },
	{  9,  7,  7 },
...
// precalculated integer DCT coefficients
const signed short icos[ 64 ] = 
{
...
// "standard" quantizer tables
const short std_qtables[ 2 ][ 64 ] =
{
	{
